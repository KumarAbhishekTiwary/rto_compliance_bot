...
def send_escalation_email(to: list[str], cc: list[str], subject: str,
                          html_body: str) -> dict:
    """Send escalation email via Gmail SMTP."""
...
<body style="font-family:Arial,sans-serif;color:#333;">
  <div style="max-width:600px;margin:auto;border:1px solid #ddd;border-radius:8px;padding:20px;">
    <h2 style="color:#c62828;">⚠️ RTO Compliance Escalation</h2>
    ...
    <table style="width:100%;border-collapse:collapse;margin:15px 0;">
      ...
      <tr><td style="padding:8px;background:#f5f5f5;"><b>Period</b></td>
          <td style="padding:8px;">{period_start} → {period_end}</td></tr>
    ...
    <p><b>Action Required:</b> Please respond on this email thread OR in the Slack
    channel with confirmation that you have discussed this with the employee and
    provide justification.</p>
    <p style="color:#888;font-size:12px;">
      This is an automated notice from the RTO Compliance Bot. Do not reply to this address directly;
      reply on the thread for tracking.
    </p>
  </div>
</body>
</html>
